...
export const metadata: Metadata = {
  ...
  description:
    "The platforms and stacks Infostream operates: Oracle (Database, APEX, PL/SQL), Microsoft, Java, TypeScript, Linux, Kubernetes, and Bitdefender enterprise security.",
};
